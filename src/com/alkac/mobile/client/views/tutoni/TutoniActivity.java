/*******************************************************************************
 * TutoniActivity.java is part of the Kitchen Sink (for Touch4j 2.0)
 * 
...
public class TutoniActivity extends KitchenSinkActivity implements TutoniView.Presenter {

    public TutoniActivity(TutoniViewPlace place, ClientFactory clientFactory) {
        this.clientFactory = clientFactory;
    }
    
    @Override
    public void start(AcceptsOneWidget panel, EventBus eventBus) {
        TutoniViewImpl view = new TutoniViewImpl();
