/*******************************************************************************
 * TutMapActivity.java is part of the Kitchen Sink (for Touch4j 2.0)
 * 
...
public class TutMapActivity extends KitchenSinkActivity implements TutMapView.Presenter {

    public TutMapActivity(TutMapViewPlace place, ClientFactory clientFactory) {
        this.clientFactory = clientFactory;
    }
    
    @Override
    public void start(AcceptsOneWidget panel, EventBus eventBus) {
        TutMapViewImpl view = new TutMapViewImpl();
