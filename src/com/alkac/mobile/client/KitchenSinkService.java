/*******************************************************************************
 * KitchenSinkService.java is part of the Kitchen Sink (for Touch4j 2.0)
 * 
...
public interface KitchenSinkService extends RemoteService {
    ...
    String getVersion();
    Ferman getFerman(UserInfo userInfo, Location location);
    void setAyar(String kapishMesafe, Location location);
